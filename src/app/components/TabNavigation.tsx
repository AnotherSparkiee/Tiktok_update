      ...
      >
        {tabs.map((tab) => (
          <button
            ...
            className={`px-[13px] py-2.5 font-medium whitespace-nowrap relative flex-shrink-0 ${
              activeTab === tab.id 
                ? 'text-white' 
                : 'text-neutral-400'
            }`}
            style={{ 
              ...
              letterSpacing: '0.5px',
              fontSize: activeTab === tab.id ? '16px' : '15px'
            }}
          >
            {tab.label}
            {activeTab === tab.id && (
        ...
        {/* Сплошная серая линия под всеми вкладками */}
